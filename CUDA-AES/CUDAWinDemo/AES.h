...
#define LOOP_IN_BLOCK (16)
#define PIECE_SIZE	(1024*1024*16)

extern "C" void AesSetKeyEncode(unsigned int *, const unsigned char *, unsigned);
extern  "C" __global__ void AES128_EBC_encry_kernel( const unsigned int*, unsigned int*t, unsigned int*); 
extern "C" void AesSetKeyDecode(unsigned int *, const unsigned char *, unsigned);
extern  "C" __global__ void AES128_EBC_decry_kernel( const unsigned int*, unsigned int*t, unsigned int*); 
...
//unsigned char h_Sbox[256];
	...
	__device__ unsigned char Sbox[256] = {	
		...
		//Äæs-box
		__device__ unsigned char InvS[256] = {	
			...
			//D±í
			__device__ unsigned int D[1024] = {
...
//				unsigned int h_D[1024];
					...
					__device__ unsigned int T[1024] = {
...
extern "C" int jiami(char* md5key,char* filepath) ;
extern "C" int jiemi(char* md5key,char* filepath) ;
